        ...
        <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
          ...
          <div className='flex gap-3' >
           ...
           <div className='flex gap-3' >
            ...
            <input className='border border-gray-400 rounded py-1.5 px-3.5 w-full ' type='text' placeholder='Coutry'  />
          </div>
           <div className='flex gap-3' >
        ...
        <div className='mt-8' >
          ...
          <div className='mt-12' >
            ...
            <div className='flex gap-3 flex-col lg:flex-row' > 
              <div onClick={()=>setMethod("stripe")} className={`flex items-center gap-3 border p-2 px-3 cursor-pointer ${method=="stripe"?"bg-green-200":"" } `} >
                <p className={`min w-3.5 h-3.5 border rounded-full ${method=="stripe"?"bg-green-400":"" } `} ></p>
                <img  className="h-5 mx-4 " src={assets.stripe_logo} />
              </div>
              <div onClick={()=>setMethod("razorpay")} className={`flex items-center gap-3 border p-2 px-3 cursor-pointer ${method=="razorpay"?"bg-green-200":"" }`} >
                <p className={`min w-3.5 h-3.5 border rounded-full ${method=="razorpay"?"bg-green-400":"" } `} ></p>
                <img  className="h-5 mx-4 " src={assets.razorpay_logo} />
              </div>
              <div onClick={()=>setMethod("cod")} className={`flex items-center gap-3 border p-2 px-3 cursor-pointer ${method=="cod"?"bg-green-200":"" }  `} >
                <p className={`min w-3.5 h-3.5 border rounded-full ${method=="cod"?"bg-green-400":"" } `} ></p>
                <p className='text-gray-600 text-sm font-medium mx-4'>PAY ON DELIVERY</p>
              </div>
            </div>
