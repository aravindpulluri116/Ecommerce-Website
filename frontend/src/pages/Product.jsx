        ...
        {/*----------------------- product info------------------ */}
            <div className='flex-1'>
              ...
              <div className='flex items-center gap-1 mt-2'>
                <img src={assets.star_icon} className='w-4 5' />
                <img src={assets.star_icon} className='w-4 5' />
                <img src={assets.star_icon} className='w-4 5' />
                <img src={assets.star_icon} className='w-4 5' />
                <img src={assets.star_dull_icon} className='w-4 5' />
          ...
          {/*---------------- Desc & review section-------------- */}
                <div className='mt-20'>
                  ...
                  <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500' >
                    <p>lllllllllllllllllllllllllllllllllllllllllllllllllll</p>
                    <p>Ecommerceeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee</p>
                  </div>
                </div>
                {/*--------------------- display related prods--------------- */}
